...
void main() 
{
	...
	vec3 palettizedHsl = vec3( ivec3( hsl * PaletteSize.xyz )) * rPaletteSize.xyz;
	float palettizedAlpha = float( int( color.a * PaletteSize.w )) * rPaletteSize.w;
	vec4 palettized = vec4( palettizedHsl.r, palettizedHsl.g, palettizedHsl.b, palettizedAlpha );
