...
class Barnacle : public Monster
{
	...
	public:
		...
		virtual Vec2r eyePosition() const { return _position; }
		virtual cpBody *body() const { return _body; }
		virtual void playerContactAttack( const Vec2r &locationWorld, real injuryScale ){} // nothing, we have a more complex approach
