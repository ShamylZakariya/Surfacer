...
namespace core {
	...
	public:
		 ...
		 */
		double getReciprocalScale() const override { return 1.0 / _scale; }
		...
		dmat4 getViewMatrix() const override { return _viewMatrix; }
		dmat4 getInverseViewMatrix() const override { return _inverseViewMatrix; }
		dmat4 getProjectionMatrix() const override { return _projectionMatrix; }
		dmat4 getInverseProjectionMatrix() const override { return _inverseProjectionMatrix; }
		dmat4 getViewProjectionMatrix() const override { return _viewProjectionMatrix; }
		dmat4 getInverseViewProjectionMatrix() const override { return _inverseViewProjectionMatrix; }
