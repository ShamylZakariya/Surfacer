...
#pragma mark - BaseParticleSystemDrawComponent
	...
	public:
		...
		virtual void setSimulation(const BaseParticleSimulationRef simulation) { _simulation = simulation; }
		BaseParticleSimulationRef getSimulation() const { return _simulation.lock(); }
...
#pragma mark - BaseParticleSystem
	...
	public:
		...
		// BaseParticleSystem
		BaseParticleSimulationRef getSimulation() const { return _simulation; }
