...
#pragma mark - BoidPhysicsComponent
        ...
        public:
            ...
            double getRuleVariance() const {
                return _ruleVariance;
            }
            ...
            dvec2 getTargetVelocity() const {
                return _targetVelocity;
            }

            void setFacingDirection(dvec2 dir);

            dvec2 getFacingDirection() const {
            ...
            size_t getGravitationLayerMask(cpBody *) const override {
                return 0;
            } // not affected by ANY gravities
...
#pragma mark - Boid
        ...
        public:
            ...
            double getRuleVariance() const {
                return _boidPhysics->getRuleVariance();
            }

            BoidPhysicsComponentRef getBoidPhysicsComponent() const {
                return _boidPhysics;
            }

            BoidFlockControllerRef getFlockController() const {
                return _flockController.lock();
            }
...
#pragma mark - BoidFlockController
        ...
        public:
            ...
            */
            ...
            const vector <BoidRef> &getFlock() const {
                return _flock;
            }
            ...
            */
             ...
             */
            void setRuleContributions(rule_contributions rc) {
                _config.ruleContributions = rc;
            }

            /**
             Get the rule contributions which will be used to drive the flock
             */
            rule_contributions getRuleContributions() const {
                return _config.ruleContributions;
            }
            ...
            const vector <core::ObjectWeakRef> getTargets() const {
                return _targets;
            }
             ...
             */
            const tracking_state &getTrackingState() const {
        ...
        protected:
            ...
            boost::optional<pair < cpBB, dvec2>> _getObjectPosition(
            const core::ObjectRef &obj
            ) const;
...
#pragma mark - BoidFlock
        ...
        public:
            ...
            BoidFlockControllerRef getBoidFlockController() const {
                return _flockController;
            }

            BoidFlockDrawComponentRef getBoidDrawComponent() const {
                return _drawer;
            }
