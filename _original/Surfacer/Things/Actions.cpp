...
namespace MessageBoxType
{
	...
	Vec2 position( type t )
	{
		switch( t )
		{
			case DEFAULT: return Vec2(0.5,0); break;
			case MODAL: return Vec2(0.5,0.5); break;
			case ALERT: return Vec2(1,1); break;
			case INFO: return Vec2(1,1); break;
			case TAG: return Vec2(0,0); break; // ignored by RichTextBox
		}
