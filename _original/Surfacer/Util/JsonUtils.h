...
Vec2 JsonToVec2( const ci::JsonTree &v );
Vec3 JsonToVec3( const ci::JsonTree &v );
Vec4 JsonToVec4( const ci::JsonTree &v );
...
bool read( const ci::JsonTree &value, const std::string &name, Vec2 &into );
bool read( const ci::JsonTree &value, const std::string &name, Vec3 &into );
bool read( const ci::JsonTree &value, const std::string &name, Vec4 &into );
