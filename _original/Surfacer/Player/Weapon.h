...
class Weapon : public core::GameObject 
{
	...
	public:
		...
		virtual void setEmissionPosition( const Vec2 &p ) { _emissionPosition = p; }
		Vec2 emissionPosition() const { return _emissionPosition; }
		
		virtual void setDirection( const Vec2 &dir ) { _direction = normalize(dir); }
		Vec2 direction() const { return _direction; }
	...
	private:
		...
		init _initializer;
		bool _firing;
		Vec2 _position, _emissionPosition, _direction;
		real _range;
...
class BeamWeapon : public Weapon
{
	...
	public:
		...
		// BeamWeapon
		virtual Vec2 beamOrigin() const { return position(); }
		virtual Vec2 beamEnd() const { return _beamEnd; }
	...
	protected:
		...
		*/
		...
		raycast_target _raycast( const Vec2 &origin, const Vec2 &end, cpShape *ignore = NULL ) const;
