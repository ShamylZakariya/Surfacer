...
class Monster : public Entity
{
	...
	public:
		...
		*/
		virtual void playerContactAttack( const Vec2 &locationWorld, real injuryScale );
...
class MonsterController : public core::Component
{
	...
	public:
		...
		virtual void setDirection( const Vec2 &d ) { _direction = d; }
		...
		*/
		...
		/**
			...
			note: MonsterController checks for visibility of the player about once per second.
		*/
		virtual Vec2 lastKnownPlayerPosition() const { return _lastKnownPlayerPosition; }
	...
	protected:
		...
		*/
		virtual Vec2 _directionToPlayer() const;
		...
		*/
		virtual bool _findPlayer( Player *player, Vec2 &playerPosition ) const;
