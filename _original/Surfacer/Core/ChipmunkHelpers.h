...
// convert a chipmunk cpVect to cinder Vec2
...
// convert a cinder Vec2 or Vec2 to chipmunk cpVect
template< typename T, glm::precision P = glm::defaultp >
cpVect cpv( const glm::tvec2<T,P> &v )
{
	return ::cpv( v.x, v.y );
}
...
template< typename T, glm::precision P = glm::defaultp >
void cpBody_ToMatrix( cpBody *body, glm::tmat4x4<T,P> &mat )
{
	mat.m[0]=body->rot.x;
	mat.m[1]=body->rot.y;
	mat.m[2]=0;
