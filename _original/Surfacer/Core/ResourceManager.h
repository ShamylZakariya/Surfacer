...
class ResourceManager
{
	...
	public:
		...
		*/
		...
		ci::gl::GlslProgRef getShader( const ci::fs::path &shaderNameFragment );
		ci::gl::GlslProgRef getShader( const ci::fs::path &vertexFileNameFragment, const ci::fs::path &fragFileNameFragment );
	...
	protected:
		...
		*/
		...
		ci::gl::GlslProgRef _findShader( const dual_file_resource_key &key ) const;				
	...
	private:
		...
		typedef std::map< dual_file_resource_key, ci::gl::GlslProgRef > shader_cache;
