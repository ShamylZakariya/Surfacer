...
void cpBBDraw( cpBB bb, const ci::ColorA &color, real padding )
{
	...
	gl::color( color );
	gl::drawLine( Vec2( bb.l, bb.b ), Vec2( bb.r, bb.b ) );
	gl::drawLine( Vec2( bb.r, bb.b ), Vec2( bb.r, bb.t ) );
	gl::drawLine( Vec2( bb.r, bb.t ), Vec2( bb.l, bb.t ) );
	gl::drawLine( Vec2( bb.l, bb.t ), Vec2( bb.l, bb.b ) );	
}
